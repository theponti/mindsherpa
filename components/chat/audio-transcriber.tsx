...
import { type PressableProps, ActivityIndicator, Pressable, StyleSheet, View } from 'react-native';
...
export default function AudioTranscriber(props: AudioTranscriberProps) {
  const { onRecordingStateChange, onAudioTranscribed, onError, style, ...pressableProps } = props;
